...
public class DonationManagerTest {
	...
	public void testManagerQueueRecipientSTUDENT() {
		try {
			...
			manager.ManagerQueueRecipient(new  Recipient("Silver Spring"));
			manager.ManagerQueueRecipient(new  Recipient("Rockville"));
			manager.ManagerQueueRecipient(new  Recipient("German Town"));
			manager.ManagerQueueRecipient(new  Recipient("College Ville"));
